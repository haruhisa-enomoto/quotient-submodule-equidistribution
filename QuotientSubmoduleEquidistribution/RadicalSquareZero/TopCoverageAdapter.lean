...
structure ATopCoverageData
    ...
    (cl : QuotientSubmoduleEquidistribution.SetClosure (Nonsimple ⊕ Vertex)) where
...
variable {F : CoreFamily Core Vertex}
  {cl : QuotientSubmoduleEquidistribution.SetClosure (Nonsimple ⊕ Vertex)}
...
structure BTopCoverageData
    (F : CoreFamily Core Vertex)
    (cl : QuotientSubmoduleEquidistribution.SetClosure
...
theorem levelPolynomial_B_eq_levelPolynomial_A_mul
    ...
    {F : CoreFamily Core Vertex}
    {clA : QuotientSubmoduleEquidistribution.SetClosure
      (NonsimpleA ⊕ Vertex)}
