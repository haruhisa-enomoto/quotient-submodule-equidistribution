...
namespace QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge
...
variable
    ...
    {ι : Type vR} {κ : Type vS}
    (σ :
      _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.{uR, vR, wR}
        R ι)
    (τ :
      _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.{uS, vS, wS}
        S κ)
...
variable
    (D :
      _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.AlignedAntiEquivalence
        σ τ)
...
theorem compositionLength_eq (i : ι) :
  ...
  unfold _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.compositionLength
...
variable
    (D :
      _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.AlignedBiduality
        σ τ)
...
def lengthTwoSubPairData
    ...
    _root_.QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge.AlignedBiduality.LengthTwoSubPairData
...
theorem sClosure_isClosed_length_two_pair_of_dual_isotypicLoewyTwo
    ...
    (Q : σ.SimpleSubmodule x)
    (hclassification :
      _root_.QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge.IndecomposableSkeleton.IsotypicLoewyTwoIndecomposablesHaveSimpleTop
        τ) :
    σ.sClosure.IsClosed ({x, Q.index} : Set ι) := by
  rw [
    _root_.QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge.AlignedBiduality.sClosure_isClosed_iff_qClosure_image
      σ τ D]
  let top :=
    AlignedAntiEquivalence.simpleQuotientOfSimpleSubmodule
      σ τ D.forward Q
  ...
  have hlength :
    ...
    exact hx
  have hq :=
    _root_.QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge.IndecomposableSkeleton.qClosure_isClosed_length_two_top_pair_of_isotypicLoewyTwo
...
end QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge
