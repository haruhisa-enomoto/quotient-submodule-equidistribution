...
structure BasicizingFullIdempotent where
  ...
  basic :
    ...
    QuotientSubmoduleEquidistribution.BasicnessWrapper.IsBasicAlgebra K idem.Corner
...
structure MoritaBasicModel where
  ...
  basic : QuotientSubmoduleEquidistribution.BasicnessWrapper.IsBasicAlgebra K Carrier
...
theorem target_isSplitBasicQuotient
    ...
    QuotientSubmoduleEquidistribution.SplitBasicQuotient.IsSplitBasicQuotient K P.Carrier :=
  QuotientSubmoduleEquidistribution.BasicnessWrapper.isSplitBasicQuotient_of_isBasicAlgebra
    K P.Carrier P.basic
...
theorem exists_target_quotientCoordinateData
  ...
  QuotientSubmoduleEquidistribution.BasicnessWrapper.exists_quotientCoordinateData_of_isBasicAlgebra
    K P.Carrier P.basic
...
def rightFgEquivalence
  ...
  QuotientSubmoduleEquidistribution.MoritaConventionBridge.rightFgEquivalence
