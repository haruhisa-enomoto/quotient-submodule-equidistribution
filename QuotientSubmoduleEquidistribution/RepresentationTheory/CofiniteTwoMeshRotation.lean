...
theorem ARMeshRotationData.edgeCount_mesh
    (M : σ.ARMeshRotationData) :
    QuotientSubmoduleEquidistribution.BoundaryArrowBalance.edgeCount
  ...
  classical
  rw [QuotientSubmoduleEquidistribution.BoundaryArrowBalance.edgeCount,
    QuotientSubmoduleEquidistribution.BoundaryArrowBalance.edgeCount,
...
theorem ARMeshRotationData.natCard_QIrreducibleBoundaryPair_eq_natCard_SIrreducibleBoundaryPair
  ...
  classical
  have hmixed :=
    QuotientSubmoduleEquidistribution.BoundaryArrowBalance.mixedBoundary_eq_of_meshRotation
      (IrreduciblePair.src (σ := σ))
      (IrreduciblePair.dst (σ := σ))
  ...
  calc
    ...
    _ = QuotientSubmoduleEquidistribution.BoundaryArrowBalance.edgeCount
          (IrreduciblePair.src (σ := σ))
          (IrreduciblePair.dst (σ := σ))
          σ.injectiveIndicesᶜ σ.projectiveIndices :=
