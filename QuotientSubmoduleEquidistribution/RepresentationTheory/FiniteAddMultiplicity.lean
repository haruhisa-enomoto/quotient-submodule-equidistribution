...
namespace QuotientSubmoduleEquidistribution.FiniteAddMultiplicity
...
theorem indecomposable_retract_of_power_iso
    ...
    (hZindec : QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule R Z)
    {n : ℕ}
  ...
  letI : IsLocalRing (Module.End R Z) :=
    QuotientSubmoduleEquidistribution.Foundation.isLocalRing_end_of_isIndecomposable hZfinite hZindec
...
end QuotientSubmoduleEquidistribution.FiniteAddMultiplicity
