...
def twoVertexSupport
    ...
    QuotientSubmoduleEquidistribution.TwoVertexArrowSupport.Data Arrow where
  source a := e (source a)
  target a := e (target a)
  pair_injective := by
    intro a b hab
...
theorem twoVertexSupport_trichotomy
  ...
  QuotientSubmoduleEquidistribution.TwoVertexArrowSupport.Data.noLoops_or_oneWayLollipop_or_loopTwoCycle
...
theorem underlyingConnected_of_hasCrossExt
    ...
    (hNoParallel : NoParallelExtSupport (K := K) τ)
    (hCross :
      QuotientSubmoduleEquidistribution.TwoVertexGabrielConnectedness.HasCrossExt τ e) :
...
theorem underlyingConnected_of_blockConnected
    ...
    (e : τ.SimpleIndex ≃ Fin 2)
    (P :
      QuotientSubmoduleEquidistribution.TwoVertexGabrielConnectedness.TwoVertexPeirceExtData
        (Peirce := Peirce) τ e)
    (hConnected : ∀ z : Peirce,
  ...
  underlyingConnected_of_hasCrossExt τ D e hNoParallel
    (QuotientSubmoduleEquidistribution.TwoVertexGabrielConnectedness.TwoVertexPeirceExtData.hasCrossExt_of_blockConnected
      τ e P hConnected)
