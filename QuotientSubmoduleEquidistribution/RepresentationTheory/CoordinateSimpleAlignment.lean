...
theorem coordinateSimpleFG_indecomposable (i : I) :
    QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule Bᵐᵒᵖ (D.coordinateSimpleFG i) := by
...
def coordinateExtOneIsoAligned (i j : I) :
    AddCommGrpCat.of
      ...
      AddCommGrpCat.of
        (QuotientSubmoduleEquidistribution.GabrielArrowBridge.ExtOne sigma
...
def twoVertexPeirceExtData
  ...
  crossExt_of_crossCotangent := by
    ...
    · left
      ...
      simpa [QuotientSubmoduleEquidistribution.TwoVertexGabrielConnectedness.HasCrossExt] using hExt
    · right
