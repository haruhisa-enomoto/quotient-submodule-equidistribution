...
import QuotientSubmoduleEquidistribution.RepresentationTheory.ContravariantTransport
...
theorem moduleRadical_isIsotypicOfType_of_inFac_length_two_pair
  ...
  have hradicalMap :
    ...
    exact hzy
  exact
    _root_.QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge.IsIsotypicOfType.of_surjective_of_semisimple
...
theorem moduleTop_isIsotypicOfType_of_inFac_length_two_pair
  ...
  have hlQ :
      l = Q.index :=
    _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.simpleQuotient_index_eq_of_inFac_length_two_pair
      σ hx Q hj L
  subst l
...
theorem qClosure_isClosed_length_two_top_pair_of_isotypicLoewyTwo
  ...
  _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.qClosure_isClosed_pair_of_targetsHaveSimpleTop
    σ hx Q
...
theorem AlignedBiduality.sClosure_isClosed_iff_qClosure_image
  ...
  · intro hT
    ...
    rw [←
      _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.AlignedBiduality.image_sClosure_eq_qClosure
        σ' τ D T]
    exact congrArg
