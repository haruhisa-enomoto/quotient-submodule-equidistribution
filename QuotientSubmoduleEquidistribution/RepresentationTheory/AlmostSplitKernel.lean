...
theorem IsLeftAlmostSplit.isIndecomposableModule_source
    ...
    QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule R A := by
...
theorem MinimalRightAlmostSplitDecomposition.kernel_ar_sequence
  ...
  exact
    ⟨hleft,
      ...
      QuotientSubmoduleEquidistribution.IndecomposableSkeleton.IsLeftAlmostSplit.isIndecomposableModule_source
