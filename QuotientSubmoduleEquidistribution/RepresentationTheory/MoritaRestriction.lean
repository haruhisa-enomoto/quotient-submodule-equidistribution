...
namespace QuotientSubmoduleEquidistribution.MoritaRestriction
...
def _root_.MoritaEquivalence.fgEquivalence
    ...
    FGModuleCat.{max uA uB} A ≌ FGModuleCat.{max uA uB} B :=
  QuotientSubmoduleEquidistribution.MoritaRestriction.fgEquivalence e.eqv
...
end QuotientSubmoduleEquidistribution.MoritaRestriction
