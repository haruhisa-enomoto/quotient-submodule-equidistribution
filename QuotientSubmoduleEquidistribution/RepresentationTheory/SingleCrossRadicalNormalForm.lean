...
private theorem singleCross_mul_coordinate_zero
    ...
    a *
        (r * D.liftedCoordinate j -
          algebraMap K B
            (QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateCharacter D j r) *
...
private theorem singleCross_scalar_reduce
    ...
    (hspan : JacobsonCotangentSpannedBy (K := K) (0 : B) a 0) :
    a * r =
      QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateCharacter D 0 r • a := by
  let e0 := D.liftedCoordinate 0
  let e1 := D.liftedCoordinate 1
  let c0 :=
    QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateCharacter D 0 r
  let c1 :=
    QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateCharacter D 1 r
  ...
  calc
    ...
    _ = QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateCharacter D 0 r • a := rfl
