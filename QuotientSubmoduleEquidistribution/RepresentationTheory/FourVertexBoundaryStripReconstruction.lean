import QuotientSubmoduleEquidistribution.RepresentationTheory.FourVertexShortStripReversal
  ...
  invFun C := by
    ...
    have hval : (U.tau ⟨H, hnot⟩).1.1 =
      ...
      simpa [U, M, O, H, ARMeshRotationData.arrowInteriorOrbitData,
        QuotientSubmoduleEquidistribution.BoundaryTranslationChains.Data.interior] using hpred
    rw [hval]
