...
theorem isProjectivelyRooted_dualDeleted_iff_isInjectivelyCorooted
  ...
  · intro hroot x hx
    ...
    · have hpath : Relation.ReflTransGen
        ...
        · have h := (hedge
          ...
          simpa [e] using h
      simpa only [QuotientSubmoduleEquidistribution.RootedDigraph.ReachInside, p, y, e,
  ...
  · intro hcoroot y hy
    ...
    · simpa [e] using hpD
    · have hpath : Relation.ReflTransGen
          (QuotientSubmoduleEquidistribution.RootedDigraph.InsideEdge τ.irreducibleEdge
            (D.dualDeleted σ τ Deleted))
          (e p) (e x) := by
        apply hpx.lift e
        intro a b hab
      ...
      simpa only [QuotientSubmoduleEquidistribution.RootedDigraph.ReachInside, x, e,
...
theorem quotientFactorLadderBad_dualDeleted_iff_submoduleFactorLadderBad
  ...
  have hrel : QuotientSubmoduleEquidistribution.FactorLadder.Data.Relabeling A B eDeleted :=
...
abbrev ActualFourVertexReversalBalance :=
  QuotientSubmoduleEquidistribution.FourVertexLadderPackets.ReversalBalance
