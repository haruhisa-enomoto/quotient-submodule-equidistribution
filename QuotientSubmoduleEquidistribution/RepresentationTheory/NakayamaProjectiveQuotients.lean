...
namespace QuotientSubmoduleEquidistribution.NakayamaProjectiveQuotients
...
def uniserialTopChoice
  ...
  have hindec :
      QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule R (sigma.moduleTop i) :=
...
end QuotientSubmoduleEquidistribution.NakayamaProjectiveQuotients
