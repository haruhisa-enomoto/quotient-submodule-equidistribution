import QuotientSubmoduleEquidistribution.RepresentationTheory.ContragredientFunctor
import QuotientSubmoduleEquidistribution.RepresentationTheory.Biduality
...
theorem dualFunctor_indec
    {M : FGModuleCat.{u} R}
    (hM : QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule R M) :
    QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule Rᵐᵒᵖ
      ((dualFunctor K R).obj (Opposite.op M)) :=
...
theorem reverseDualFunctor_indec
    {N : FGModuleCat.{u} Rᵐᵒᵖ}
    (hN : QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule Rᵐᵒᵖ N) :
...
variable [IsNoetherianRing R] [IsNoetherianRing Rᵐᵒᵖ]
  ...
  (τ : QuotientSubmoduleEquidistribution.IndecomposableSkeleton.{u, w, u} Rᵐᵒᵖ κ)
...
noncomputable def alignedBiduality :
    QuotientSubmoduleEquidistribution.IndecomposableSkeleton.AlignedBiduality σ τ where
  forward :=
