...
def coordinateSimpleIso_reindex (j : J) :
    QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimple
        (D.reindex p) j ≅
      QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimple
        D (p.symm j) := by
  let L :
...
variable {kappa : Type x} [IsNoetherianRing Bᵐᵒᵖ]
  (tau : QuotientSubmoduleEquidistribution.IndecomposableSkeleton.{u, x, u} Bᵐᵒᵖ kappa)
...
theorem coordinateSimpleIndexEquiv_reindex :
  ...
  let eFG :
      QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimpleFG
          (D.reindex p) j ≅
        QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimpleFG
          D (p.symm j) :=
    F.preimageIso
      (QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimpleFGForgetIso
          (D.reindex p) j ≪≫
  ...
  apply tau.eq_of_iso
  exact ⟨
    (QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimpleFGIsoAligned
...
private theorem alignedExtTwoVertexSupport_source_reindex
  ...
  change
    (QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimpleIndexEquiv
      ...
      p ((QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimpleIndexEquiv
...
theorem splitBasic_twoVertexSupport_eq_aligned
    (G : QuotientSubmoduleEquidistribution.IndecomposableSkeleton.FaithfulCore.ConnectedSmallCore.SplitBasicExtGabrielArrowRealization.Data
      (K := K) tau) :
    QuotientSubmoduleEquidistribution.IndecomposableSkeleton.FaithfulCore.ConnectedSmallCore.SplitBasicExtGabrielArrowRealization.twoVertexSupport
        tau G
          (QuotientSubmoduleEquidistribution.CotangentExtBridge.CoordinateData.coordinateSimpleIndexEquiv
