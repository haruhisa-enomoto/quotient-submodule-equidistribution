...
namespace QuotientSubmoduleEquidistribution.ProjectiveSimpleTop
...
theorem simple_top_of_indec_projective
    ...
    (hindec : QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule R P) :
    IsSimpleModule R (P ⧸ Module.jacobson R P) := by
  letI : Nontrivial P := hindec.nontrivial
  letI : IsLocalRing (Module.End R P) :=
    QuotientSubmoduleEquidistribution.Foundation.isLocalRing_end_of_isIndecomposable hfinite hindec
...
theorem jacobsonQuotientMap_isEssentialEpi
    ...
    [Nontrivial P] [Module.Finite R P] [Module.Projective R P]
    [IsLocalRing (Module.End R P)] :
    QuotientSubmoduleEquidistribution.Tsukamoto.StandardSemantics.IsEssentialEpi
...
end QuotientSubmoduleEquidistribution.ProjectiveSimpleTop
