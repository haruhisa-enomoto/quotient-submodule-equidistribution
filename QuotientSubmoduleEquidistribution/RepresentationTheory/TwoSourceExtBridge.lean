...
namespace QuotientSubmoduleEquidistribution.TwoTypeSemisimple
...
end QuotientSubmoduleEquidistribution.TwoTypeSemisimple
...
theorem simpleTopSubmodule_type_eq_left_or_right
  ...
  have hMLindec : QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule R ML :=
...
theorem compositionLength_eq_three_of_two_simpleQuotientTypes
  ...
  have hRadIndec : QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule Aᵐᵒᵖ Rad :=
    QuotientSubmoduleEquidistribution.Foundation.IsSimpleModule.isIndecomposableModule
...
theorem qClosedTriple_existsUnique_familyKind_of_longUniserialControl
    ...
    ∀ {iota : Type x} [Finite iota]
      ...
      ∀ {S : Set iota}, S.ncard = 3 → sigma.qClosure.IsClosed S →
        ∃! k : _root_.QuotientSubmoduleEquidistribution.IndecomposableSkeleton.QTripleFamilyKind,
