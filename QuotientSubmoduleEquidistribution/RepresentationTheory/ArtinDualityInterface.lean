...
def ringelEtaStableEquivalence (D : Data R) :
    TorsionlessStableCategory (R := R) ≌
      CotorsionlessStableCategory (R := R) :=
  (QuotientSubmoduleEquidistribution.RingelEta.ringelTorsionlessStableAntiEquivalence
      (QuotientSubmoduleEquidistribution.RingelEta.regularHomProjectiveAntiEquivalence
...
def projectiveInjectiveLabelEquiv (D : Data R)
  ...
  QuotientSubmoduleEquidistribution.RingelStable.projectiveInjectiveLabelEquivOfAntiEquivalence
    σ D.moduleEquiv
...
def ringelCoreEquiv (D : Data R)
  ...
  QuotientSubmoduleEquidistribution.RingelStable.coreEquivOfEtaStableData σ
...
def ofFiniteDimensional
    ...
    Data R where
  moduleEquiv :=
    QuotientSubmoduleEquidistribution.Contragredient.reverseDualityEquivalence K R
