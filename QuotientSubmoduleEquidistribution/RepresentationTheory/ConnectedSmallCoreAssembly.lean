...
structure CommonOppositeQuotientPolynomial
    ...
    (tau :
      QuotientSubmoduleEquidistribution.IndecomposableSkeleton.{u, v, u}
...
abbrev NakayamaChainModel (B : AlgebraNode K) : Prop :=
  Nonempty
    (QuotientSubmoduleEquidistribution.NakayamaModuleChains.FixedTopSocleChainClassification
      B.skeleton)
...
abbrev NakayamaProfileModel (B : AlgebraNode K) : Prop :=
  QuotientSubmoduleEquidistribution.LocalNakayamaBranch.HasMoritaMonogenicModel B ∨
    QuotientSubmoduleEquidistribution.LocalNakayamaBranch.HasMoritaOneLoopPresentation B ∨
...
theorem fullProfileEquality_of_nakayamaProfileModel
  ...
  · exact
      QuotientSubmoduleEquidistribution.LocalNakayamaBranch.algebraNodeEquidistribution_of_hasMoritaMonogenicModel
        B hmonogenic
  · exact
      QuotientSubmoduleEquidistribution.LocalNakayamaBranch.algebraNodeEquidistribution_of_hasMoritaOneLoopPresentation
        B hpresentation
...
theorem nakayamaProfileModel_of_splitCyclicCotangent
    (B : AlgebraNode K)
    (P :
      QuotientSubmoduleEquidistribution.LocalNakayamaBranch.MoritaSplitCyclicCotangentModel
        K B) :
...
theorem simpleIndex_nonempty
  ...
  have hindec :
      QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule B.Carrier X :=
...
theorem indexCard_eq_coreSize_of_projectiveCount_eq_one
  ...
  have hOne :
      QuotientSubmoduleEquidistribution.LocalNakayamaBranch.OneSimple B.skeleton :=
    (QuotientSubmoduleEquidistribution.LocalNakayamaBranch.oneSimple_iff_projectiveRank_eq_one
  ...
  have hCardCore :
    ...
    QuotientSubmoduleEquidistribution.OneSimpleCoreSaturation.natCard_eq_quotientCore_ncard_of_submoduleCore_eq_univ
...
open QuotientSubmoduleEquidistribution.BottomLevels.ConnectedSmallCore
