...
namespace QuotientSubmoduleEquidistribution.LollipopConcrete.B1.ModuleLayer.ClassificationBridge
...
theorem obj_indecomposable (i : Label) :
    QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule (B1Model K) (obj K i) := by
...
theorem classification
  ...
  have hY : ∀ t, QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule (B1Model K) (Y t) := by
    intro t
...
theorem indecomposable_iso_exactly_one
    ...
    (hM : QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule (B1Model K) M) :
...
end QuotientSubmoduleEquidistribution.LollipopConcrete.B1.ModuleLayer.ClassificationBridge
