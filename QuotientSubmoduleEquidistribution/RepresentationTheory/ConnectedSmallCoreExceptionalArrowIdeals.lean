...
theorem indecomposable_of_top_iso
    ...
    (eTop :
      FGModuleCat.of Aᵐᵒᵖ
          (QuotientSubmoduleEquidistribution.Tsukamoto.cyclicRightIdealFG a ⧸
            Module.jacobson Aᵐᵒᵖ
              (QuotientSubmoduleEquidistribution.Tsukamoto.cyclicRightIdealFG a)) ≅
        τ.obj j.1) :
    QuotientSubmoduleEquidistribution.Foundation.IsIndecomposableModule Aᵐᵒᵖ
      (QuotientSubmoduleEquidistribution.Tsukamoto.cyclicRightIdealFG a) := by
  ...
  exact QuotientSubmoduleEquidistribution.FamilyFourControl.isIndecomposableModule_of_simple_top
    hTop
...
theorem inSubOfProjectiveGenerator (a : A) :
  ...
  (torsionless_iff_inSubOfModule_projectiveGenerator τ
    (QuotientSubmoduleEquidistribution.Tsukamoto.cyclicRightIdealFG a)).1
      (QuotientSubmoduleEquidistribution.Tsukamoto.cyclicRightIdeal_torsionless a)
