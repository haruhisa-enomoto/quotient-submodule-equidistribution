...
def reindex
    (D : QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData
      (K := K) (B := B) (I := I))
    (e : I ≃ J) :
...
namespace QuotientSubmoduleEquidistribution.BasicTwoCoordinateData
...
theorem exists_twoCoordinateData_of_isBasicAlgebra
  ...
  exact
    ⟨QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData.reindex
      D e⟩
...
end QuotientSubmoduleEquidistribution.BasicTwoCoordinateData
