...
namespace QuotientSubmoduleEquidistribution.HereditaryNoSelfExt
...
theorem selfExtOne_subsingleton_of_finitelyGeneratedLeftHereditary
  ...
  obtain ⟨D⟩ :=
    QuotientSubmoduleEquidistribution.RingelStable.FaithfulCoreAdapter.inAdd_projectiveLabels_of_projective
...
end QuotientSubmoduleEquidistribution.HereditaryNoSelfExt
