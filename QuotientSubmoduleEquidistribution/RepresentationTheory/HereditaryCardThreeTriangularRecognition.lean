...
variable
  (sigma : QuotientSubmoduleEquidistribution.IndecomposableSkeleton.{u, v, u} B iota)
    ...
    have hEndpoints :
      ...
      calc
        E (LengthTwo.target sigma xSigma) =
          ...
          (QuotientSubmoduleEquidistribution.ExtDualTransport.AlignedAntiEquivalence.source_lengthTwoEquiv
        ...
        _ = E (LengthTwo.source sigma xSigma) :=
          QuotientSubmoduleEquidistribution.ExtDualTransport.AlignedAntiEquivalence.target_lengthTwoEquiv
            sigma tau A xSigma
