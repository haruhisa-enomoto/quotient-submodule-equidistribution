...
namespace QuotientSubmoduleEquidistribution.ExtForkSemisimpleLayers
...
theorem incoming_parallel_extGabrielFork_of_two_simple_quotient
  ...
  have hdim : 2 ≤ Module.finrank K (ExtOne tau p t) := by
    ...
    have hsource : Module.finrank K (Fin 2 → K) ≤ 1 :=
      QuotientSubmoduleEquidistribution.LoewyTwoRankCore.source_finrank_le_one harrow
    simp at hsource
...
end QuotientSubmoduleEquidistribution.ExtForkSemisimpleLayers
