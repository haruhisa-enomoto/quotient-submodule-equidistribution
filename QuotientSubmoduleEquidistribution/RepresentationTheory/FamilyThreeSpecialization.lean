...
namespace QuotientSubmoduleEquidistribution.FamilyThreeSpecialization
...
theorem target_ne_of_ne_of_source_eq
    ...
    (hne : e₁ ≠ e₂)
    (hsource :
      QuotientSubmoduleEquidistribution.GabrielArrowBridge.LengthTwo.source
          (A := Aᵐᵒᵖ) σ e₁ =
        QuotientSubmoduleEquidistribution.GabrielArrowBridge.LengthTwo.source
          (A := Aᵐᵒᵖ) σ e₂) :
    QuotientSubmoduleEquidistribution.GabrielArrowBridge.LengthTwo.target
        (A := Aᵐᵒᵖ) σ e₁ ≠
      QuotientSubmoduleEquidistribution.GabrielArrowBridge.LengthTwo.target
        (A := Aᵐᵒᵖ) σ e₂ := by
  intro htarget
...
theorem facPresentation_sourceRadical_isSemisimple_commonSourcePair
  ...
  have hlabel := P.mem t
  rcases (by
    simpa [QuotientSubmoduleEquidistribution.IndecomposableSkeleton.commonSourcePairSupport]
      ...
      have erad : Nonempty
        ...
        exact
          QuotientSubmoduleEquidistribution.LengthTwoGabrielBridge.IndecomposableSkeleton.moduleRadical_linearEquiv_simpleSubmodule
            σ e₁.1.2
              (QuotientSubmoduleEquidistribution.GabrielArrowBridge.LengthTwo.submodule σ e₁.1)
      exact
...
end QuotientSubmoduleEquidistribution.FamilyThreeSpecialization
