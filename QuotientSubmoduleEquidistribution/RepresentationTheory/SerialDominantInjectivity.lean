...
def IsMaximumLengthUniserialSubmodule (i : kappa)
  ...
  U ≠ ⊥ ∧ QuotientSubmoduleEquidistribution.IsUniserialModule R U ∧
    ∀ V : Submodule R (tau.obj i),
      V ≠ ⊥ → QuotientSubmoduleEquidistribution.IsUniserialModule R V →
...
theorem length_quotient_jacobson_smul_le_one
    ...
    [AddCommGroup P] [Module R P]
    (hP : QuotientSubmoduleEquidistribution.IsUniserialModule R P) :
    Module.length R
...
theorem maximumLengthUniserialSubmodulesAreDominantInjective_of_hulls
    ...
    {kappa : Type u}
    (tau : QuotientSubmoduleEquidistribution.IndecomposableSkeleton.{u, u, u} R kappa)
    (hHull :
      ∀ (i : kappa) (U : Submodule R (tau.obj i)),
        IsMaximumLengthUniserialSubmodule tau i U →
...
theorem length_quotient_jacobson_pow_smul_le
    {R P : Type u} [Ring R] [IsSemiprimaryRing R]
    [AddCommGroup P] [Module R P]
    (hP : QuotientSubmoduleEquidistribution.IsUniserialModule R P) (k : ℕ) :
    Module.length R
  ...
  | succ k ih =>
      ...
      have hkerUniserial :
          QuotientSubmoduleEquidistribution.IsUniserialModule R (LinearMap.ker q) :=
...
theorem idealAnnihilates_jacobson_pow_ambient_of_projective_boundary
  ...
  have hSource : QuotientSubmoduleEquidistribution.IsUniserialModule R (tau.obj (P.label t)) :=
  ...
  have hVuniserial : QuotientSubmoduleEquidistribution.IsUniserialModule R V :=
    QuotientSubmoduleEquidistribution.ExtDegreeNakayamaReduction.isUniserialModule_congr
...
theorem maximumLengthUniserialSubmodulesAreDominantInjective_of_projective_boundary
  ...
  have hQuniserial : QuotientSubmoduleEquidistribution.IsUniserialModule R (tau.obj q) :=
    QuotientSubmoduleEquidistribution.ExtDegreeNakayamaReduction.isUniserialModule_congr
  ...
  have hfUSurj : Function.Surjective fU.hom.hom :=
    (QuotientSubmoduleEquidistribution.IndecomposableSkeleton.fg_epi_iff_surjective fU).mp
      inferInstance
  ...
  have hPuniserial :
      QuotientSubmoduleEquidistribution.IsUniserialModule R (tau.obj pIndex) :=
