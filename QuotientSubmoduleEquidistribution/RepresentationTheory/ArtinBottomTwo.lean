...
namespace QuotientSubmoduleEquidistribution.ArtinBottomTwo
...
abbrev factorSkeleton (I : TwoSidedIdeal R) :=
  QuotientSubmoduleEquidistribution.QuotientSkeletonAlignment.artinFactorSkeleton R I
...
theorem finiteDimensionalPairEquiv_annihilator (C : ArtinQPair σ) :
  ...
  exact pairEquiv_annihilator σ
    (fun _ ↦ QuotientSubmoduleEquidistribution.ArtinDuality.ofFiniteDimensional K) C

end FiniteDimensional

end QuotientSubmoduleEquidistribution.ArtinBottomTwo
