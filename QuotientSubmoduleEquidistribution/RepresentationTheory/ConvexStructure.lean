...
theorem qExtremePoints_eq_relativeSplitProjectives
  ...
  ext x
  rw [QuotientSubmoduleEquidistribution.SetClosure.mem_extremePoints,
...
theorem qClosure_infiniteConvexStructure_of_finiteDimensional
  ...
  QuotientSubmoduleEquidistribution.SetClosure.infiniteConvexStructure
  ...
  letI : ∀ i : ι,
    ...
    fun i ↦
      QuotientSubmoduleEquidistribution.isArtinianRing_moduleEnd_of_finiteDimensional
        (K := K) (B := R) (M := σ.obj i)
  have hbasis :=
    QuotientSubmoduleEquidistribution.SetClosure.compact_extremePoints_basis
      (qClosure_isFinitary σ)
...
theorem qCompact_isMinimalGenerator_iff_eq_relativeSplitProjectives
  ...
  exact
    QuotientSubmoduleEquidistribution.SetClosure.compact_isMinimalGenerator_iff_eq_extremePoints
      (qClosure_isFinitary σ)
      (qClosure_isAntiExchange σ) hcompact
  ...
  letI : ∀ i : ι,
    ...
    fun i ↦
      QuotientSubmoduleEquidistribution.isArtinianRing_moduleEnd_of_finiteDimensional
        (K := K) (B := R) (M := σ.obj i)
  obtain ⟨x, hxextreme⟩ :=
    QuotientSubmoduleEquidistribution.SetClosure.extremePoints_nonempty
...
theorem qClosure_relativeSplitProjectives
  ...
  rw [← qExtremePoints_eq_relativeSplitProjectives σ]
  exact
    QuotientSubmoduleEquidistribution.SetClosure.closure_extremePoints
