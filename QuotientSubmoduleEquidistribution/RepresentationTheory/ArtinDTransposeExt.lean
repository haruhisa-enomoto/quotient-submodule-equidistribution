...
abbrev dTransposeExtPresentationRange
  ...
  QuotientSubmoduleEquidistribution.InjectivePresentationExt.presentationRange
...
theorem mem_dTransposeExtPresentationRange_iff
  ...
  exact QuotientSubmoduleEquidistribution.InjectivePresentationExt.mem_presentationRange_iff
...
abbrev dTransposeConnectingLinear
  ...
  QuotientSubmoduleEquidistribution.InjectivePresentationExt.connectingLinear
...
def dTransposeExtOneQuotientLinearEquiv
    ...
    ((Y ⟶ P.dTransposeCokernel D) ⧸
      ...
      Ext.{w} Y (P.dTranspose D) 1 :=
  QuotientSubmoduleEquidistribution.InjectivePresentationExt.quotientLinearEquivExtOne
    (k := k) (P.dTransposeInjectivePresentation D).shortExact_shortComplex Y
...
theorem dTransposeExtOneQuotientLinearEquiv_mk
  ...
  exact QuotientSubmoduleEquidistribution.InjectivePresentationExt.quotientLinearEquivExtOne_mk
...
abbrev dTransposePrecompQuotient
  ...
  QuotientSubmoduleEquidistribution.InjectivePresentationExt.precompQuotient
...
theorem dTransposeExtOneQuotientLinearEquiv_precomp
    ...
    P.dTransposeExtOneQuotientLinearEquiv (k := k) D Y
      ...
      (Ext.mk₀ g).comp
        ...
        (zero_add 1) := by
  exact
    QuotientSubmoduleEquidistribution.InjectivePresentationExt.quotientLinearEquivExtOne_precompQuotient
