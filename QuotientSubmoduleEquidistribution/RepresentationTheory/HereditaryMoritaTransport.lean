...
namespace QuotientSubmoduleEquidistribution.HereditaryMoritaTransport
...
theorem finitelyGeneratedLeftHereditary_of_fgEquivalence
  ...
  exact
    QuotientSubmoduleEquidistribution.RingelStable.moduleProjective_of_fgProjective X
...
end QuotientSubmoduleEquidistribution.HereditaryMoritaTransport
