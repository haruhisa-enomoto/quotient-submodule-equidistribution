import QuotientSubmoduleEquidistribution.ConvexGeometry.CofiniteTwoCardinal
import QuotientSubmoduleEquidistribution.RepresentationTheory.ArtinFiniteTypeAlmostSplit
import QuotientSubmoduleEquidistribution.RepresentationTheory.LocalARBoundaryFiniteness
import QuotientSubmoduleEquidistribution.RepresentationTheory.ProjectiveBoundaryAlmostSplit
import QuotientSubmoduleEquidistribution.RepresentationTheory.TwoSidedLocalARData
...
theorem finite_injectiveLabels :
  ...
  letI : Finite {i : ι // Projective (σ.obj i)} :=
    Set.finite_coe_iff.mpr
      (QuotientSubmoduleEquidistribution.NakayamaRepresentationFiniteBridge.finite_projectiveLabels σ)
...
theorem finite_qCofiniteTwoDeletionSet :
  ...
  have htop : σ.qClosure.topExtremeSet.Finite := by
    ...
    exact
      QuotientSubmoduleEquidistribution.NakayamaRepresentationFiniteBridge.finite_projectiveLabels σ
  exact
    QuotientSubmoduleEquidistribution.SetClosure.finite_cofiniteTwoDeletionSet
...
theorem qCofiniteTwoNcard_eq_choose_simpleIndex_add_radicalBoundary :
  ...
  calc
    σ.qClosure.cofiniteTwoDeletionSet.ncard =
      ...
      QuotientSubmoduleEquidistribution.SetClosure.ncard_cofiniteTwoDeletionSet_eq_choose_add
        σ.qClosure (qClosure_isAntiExchange σ) htop
...
def TwoSidedLocalARData.ofArtinDuality
    (A : QuotientSubmoduleEquidistribution.ArtinDuality.Data R)
  ...
  boundary := by
    simpa [QuotientSubmoduleEquidistribution.RingelStable.projectiveSet,
      ...
      QuotientSubmoduleEquidistribution.ArtinDuality.projectiveInjectiveLabelEquiv A σ
