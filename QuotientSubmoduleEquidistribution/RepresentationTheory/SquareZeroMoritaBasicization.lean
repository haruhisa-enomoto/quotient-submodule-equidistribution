...
abbrev RadicalBimodule :=
  QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData.RadicalBimodule
    P.coordinateData
...
instance radicalBimoduleFinite : Module.Finite K P.RadicalBimodule := by
  apply Module.Finite.of_injective
    (QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData.RadicalBimodule.inclusion
      P.coordinateData)
  intro x y hxy
  apply QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData.RadicalBimodule.ext'
    P.coordinateData
  apply Subtype.ext
  exact hxy
...
def squareZeroAlgEquiv :
  ...
  QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData.RadicalBimodule.squareZeroAlgEquiv
...
def squareZeroLeftModuleEquivalence :
  ...
  QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData.RadicalBimodule.squareZeroLeftModuleEquivalence
    P.coordinateData P.squareZeroModel.radical_sq
...
def squareZeroRightModuleEquivalence :
  ...
  QuotientSubmoduleEquidistribution.SplitBasicCoordinateSystem.QuotientCoordinateData.RadicalBimodule.squareZeroRightModuleEquivalence
    P.coordinateData P.squareZeroModel.radical_sq
...
def squareZeroLeftFgEquivalence :
  ...
  exact QuotientSubmoduleEquidistribution.MoritaRestriction.fgEquivalence
