...
namespace QuotientSubmoduleEquidistribution.RepresentationDirected.DirectedSorting
...
open QuotientSubmoduleEquidistribution.RepresentationDirected.FirstCancellation
...
theorem directedSorting
    ...
    (hMeshExactness : ∀ a : Fin (OrderedARWord.word sigma H T).length,
      PositiveRightAdditiveForcesMeshInverseNonnegative
        ...
        (segmentWord (OrderedARWord.word sigma H T)
          (rowRestrictedOmissions D a))) :
    (QuotientSubmoduleEquidistribution.RepresentationDirected.FixedWord.IsLeftmostReducedSubwordFor
        (system (OrderedARWord.orbitGraph sigma H T))
        (OrderedARWord.word sigma H T)
...
end QuotientSubmoduleEquidistribution.RepresentationDirected.DirectedSorting
