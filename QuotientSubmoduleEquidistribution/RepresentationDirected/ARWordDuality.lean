...
namespace QuotientSubmoduleEquidistribution.RepresentationDirected.ARWordDuality
...
def transportedRightARCokernelIso
  ...
  (QuotientSubmoduleEquidistribution.cokernelPrecompMapOpIsoKernel D.categoryEquiv
...
theorem arStep_reversed_at
  ...
  obtain ⟨ec⟩ := QuotientSubmoduleEquidistribution.nonempty_cokernelIso_of_leftAlmostSplit
...
end QuotientSubmoduleEquidistribution.RepresentationDirected.ARWordDuality
