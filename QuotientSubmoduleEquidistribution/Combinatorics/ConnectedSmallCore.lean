...
namespace QuotientSubmoduleEquidistribution.BottomLevels.ConnectedSmallCore
...
variable {E : Type v} [Finite E]
  {c : QuotientSubmoduleEquidistribution.SetClosure E}
  {Faithful : Set E → Prop}
...
variable {B : Type u}
  (Index : B → Type v)
  [∀ b : B, Finite (Index b)]
  (cQ cS : ∀ b : B, QuotientSubmoduleEquidistribution.SetClosure (Index b))
...
end QuotientSubmoduleEquidistribution.BottomLevels.ConnectedSmallCore
