...
abbrev Interior (_T :
    QuotientSubmoduleEquidistribution.BoundaryTranslationChains.Data Vertex P I) :=
  {x : Vertex // ¬ P x ∧ ¬ I x}
...
def interior :
    QuotientSubmoduleEquidistribution.BoundaryTranslationChains.Data T.Interior
...
theorem interiorTarget_iff_target_successor (x : T.Interior) :
  ...
  classical
  simp [InteriorTarget,
    QuotientSubmoduleEquidistribution.BoundaryTranslationChains.Data.successor, x.2.2]
...
def twoStep :
    QuotientSubmoduleEquidistribution.BoundaryTranslationChains.Data Vertex
...
variable {Vertex₂ : Type v} {P₂ I₂ : Vertex₂ → Prop}
  (U : QuotientSubmoduleEquidistribution.BoundaryTranslationChains.Data Vertex₂ P₂ I₂)

/-- Product partial translation.  A pair is on a boundary when either of
its coordinates is on the corresponding boundary. -/
def prod :
    QuotientSubmoduleEquidistribution.BoundaryTranslationChains.Data (Vertex × Vertex₂)
