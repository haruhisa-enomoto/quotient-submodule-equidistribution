...
theorem isMiddle_iff_retract_chosenRightARAtMiddle
  ...
  (isMiddle_iff_hasIrreducibleMorphism sigma H D y x).trans
    (OpConjecture.IndecomposableSkeleton.MinimalRightAlmostSplitDecomposition.indecomposableRetract_middle_iff_irreducible
...
theorem image_middlePositions_eq_chosenRightARAt_support
  ...
  constructor
  · rintro ⟨y, hy, rfl⟩
    exact (OpConjecture.IndecomposableSkeleton.MinimalRightAlmostSplitDecomposition.summandIrreducibleCorrespondence
        (chosenRightARAt sigma D (positionEquiv sigma H D x))
  ...
  · intro hz
    ...
    have hirr : HasIrreducibleMorphism
      ...
      simpa only [y, positionEquiv_symm_apply_apply] using
        (OpConjecture.IndecomposableSkeleton.MinimalRightAlmostSplitDecomposition.summandIrreducibleCorrespondence
