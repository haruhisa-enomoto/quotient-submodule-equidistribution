...
namespace OpConjecture.RepresentationDirected.IyamaMesh.WordMesh.RightRealization
...
theorem mat_exact_at_middle
    ...
    (hAlt : HasInteriorAlternation G Q) (s x : Fin Q.length) :
    Function.Exact
      (OpConjecture.RepresentationDirected.postcompLinearMap
  ...
  · intro hf
    ...
    exact ha
  · rintro ⟨g, rfl⟩
    simp only [OpConjecture.RepresentationDirected.postcompLinearMap_apply]
...
end OpConjecture.RepresentationDirected.IyamaMesh.WordMesh.RightRealization
