...
namespace OpConjecture.RepresentationDirected.IyamaMesh.WordMesh.DirectedEndpoint

open OpConjecture.RepresentationDirected.FixedWord
open OpConjecture.RepresentationDirected
open OpConjecture.RepresentationDirected.ARWordDuality
open OpConjecture.RepresentationDirected.DirectedAROrbit
open OpConjecture.RepresentationDirected.DualDirectedOrder
open OpConjecture.RepresentationDirected.OppositeDirectedProfile
...
open OpConjecture.RepresentationDirected.IyamaMesh.WordMesh.PreStrictRealization
...
def explicitProfileParametrization
    ...
    (E : DirectedOrderChoice sigma) :
    OpConjecture.RepresentationDirected.ProfileParametrization sigma
      (BruhatLowerInterval
...
theorem quotientSubmoduleEquidistribution
    ...
    (Ttau : tau.FiniteARTranslationData)
    (E : DirectedOrderChoice sigma) :
    sigma.QuotientSubmoduleEquidistribution :=
...
end OpConjecture.RepresentationDirected.IyamaMesh.WordMesh.DirectedEndpoint
