...
public import OpConjecture.Foundation.RepresentationTheory.Quiver.Acyclic.FinitePaths
public import OpConjecture.Foundation.RepresentationTheory.Quiver.PathAlgebra
...
`OpConjecture.Foundation.RepresentationTheory.Quiver.PathAlgebra` meets acyclicity, which is why it is a module of
its own: the path algebra itself needs nothing from the theory of acyclic quivers.

## Main results

* `OpConjecture.Foundation.finiteDimensional_pathAlgebra_of_isAcyclic`: the path algebra of a finite acyclic
