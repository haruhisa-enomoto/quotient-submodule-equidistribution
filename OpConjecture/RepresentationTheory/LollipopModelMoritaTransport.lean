...
namespace OpConjecture.LollipopConcrete.ModelTransport
...
def IsMoritaLollipop
    (B : AlgebraNode K)
    (kind : OpConjecture.BottomLevels.ConnectedSmallCore.LollipopKind) : Prop :=
...
theorem faithfulLevelCount_eq_of_oppositeMorita
    ...
    (sigma : OpConjecture.IndecomposableSkeleton.{u, v, u} A iota)
    (B : AlgebraNode K)
  ...
  have hDualQ :
      MinimalFaithfulCore.faithfulLevelCount B.skeleton.qClosure
        ...
        MinimalFaithfulCore.faithfulLevelCount tau.sClosure
          (AnnihilatorInflation.IsFaithfulSupport tau.obj) n :=
    OpConjecture.IndecomposableSkeleton.AlignedBiduality.quotientFaithfulLevelCount_eq_submodule
      B.skeleton tau
  ...
  have hDualS :
      MinimalFaithfulCore.faithfulLevelCount B.skeleton.sClosure
        ...
        MinimalFaithfulCore.faithfulLevelCount tau.qClosure
          (AnnihilatorInflation.IsFaithfulSupport tau.obj) n :=
    OpConjecture.IndecomposableSkeleton.AlignedBiduality.submoduleFaithfulLevelCount_eq_quotient
      B.skeleton tau
      (closedFaithfulNormalForm (K := K) B.skeleton)
      (closedFaithfulNormalForm (K := K) tau) D
      (AnnihilatorInflation.isFaithfulSupport_monotone B.skeleton.obj)
...
theorem faithfulLevelCount_four_eq_of_isMoritaLollipop
    (B : AlgebraNode K)
    (kind : OpConjecture.BottomLevels.ConnectedSmallCore.LollipopKind)
...
end OpConjecture.LollipopConcrete.ModelTransport
