...
def rootedBadCofiniteInput_of_factorLadders
    ...
    (M : OpConjecture.RootedDigraph.GroupedTopPartMatching
    ...
    OpConjecture.SetClosure.RootedBadCofiniteInput
      σ.qClosure σ.sClosure j :=
  OpConjecture.SetClosure.rootedBadCofiniteInput_of_groupedTopPartMatching
...
theorem levelCount_card_sub_eq_of_factorLadders
  ...
  exact
    OpConjecture.SetClosure.levelCount_card_sub_eq_of_rootedBadCofiniteInput
...
theorem levelCount_card_sub_eq_of_badRootedFactorLadderBalance
  ...
  letI : IsNoetherianRing Rᵐᵒᵖ :=
    OpConjecture.isNoetherianRing_op_of_finiteDimensional k R
