...
theorem isCompletelyJoinIrreducible_map (e : A ≃o B) {a : A}
    (ha : OpConjecture.IsCompletelyJoinIrreducible a) :
    OpConjecture.IsCompletelyJoinIrreducible (e a) := by
  intro S hS
...
theorem isCompletelyJoinIrreducible_iff (e : A ≃o B) (a : A) :
    OpConjecture.IsCompletelyJoinIrreducible a ↔
      OpConjecture.IsCompletelyJoinIrreducible (e a) :=
...
theorem support_iInf {κ : Sort*}
  ...
  exact OpConjecture.SetClosure.coe_iInf _
...
theorem support_iSup {κ : Sort*}
  ...
  exact OpConjecture.SetClosure.coe_iSup _
...
theorem isCompletelyJoinIrreducible_iff
    (C : QuotientClosedAdditiveSubcategory (R := R)) :
    let _ := quotientClosedCompleteLattice σ
    OpConjecture.IsCompletelyJoinIrreducible C ↔
        OpConjecture.IsCompletelyJoinIrreducible
