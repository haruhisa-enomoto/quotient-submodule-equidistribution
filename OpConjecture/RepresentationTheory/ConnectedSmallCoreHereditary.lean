...
theorem torsionless_iff_inSubOfModule_projectiveGenerator
    (X : FGModuleCat.{u} R) :
    OpConjecture.RingelStable.FaithfulCoreAdapter.Torsionless X ↔
      IndecomposableSkeleton.InSubOfModule
  ...
  · exact
      OpConjecture.RingelStable.FaithfulCoreAdapter.torsionless_of_inSubOfModule
...
theorem projective_of_torsionless_of_projectiveRank_eq_core
    ...
    (X : FGModuleCat.{u} R)
    (hX : OpConjecture.RingelStable.FaithfulCoreAdapter.Torsionless X) :
    Projective X := by
  apply
...
theorem moduleProjective_submodule_of_fgProjective_of_projectiveRank_eq_core
  ...
  exact OpConjecture.RingelStable.moduleProjective_of_fgProjective X hX
