...
theorem realized_isIndecomposable_iff
    ...
    OpConjecture.Foundation.IsIndecomposableModule (Algebra S J) (Realized D) ↔
...
theorem ofModule_isIndecomposableSeparatedData
    ...
    (hX : OpConjecture.Foundation.IsIndecomposableModule (Algebra S J) X) :
    IsIndecomposableSeparatedData (ofModule (S := S) (J := J) X) := by
  let D := ofModule (S := S) (J := J) X
  let e := realizedOfModuleIso (S := S) (J := J) X
  have hRealized : @OpConjecture.Foundation.IsIndecomposableModule
...
theorem top_isIndecomposable_of_radical_subsingleton
    ...
    OpConjecture.Foundation.IsIndecomposableModule S D.top := by
...
theorem radical_isIndecomposable_of_top_subsingleton
    ...
    OpConjecture.Foundation.IsIndecomposableModule S D.radical := by
