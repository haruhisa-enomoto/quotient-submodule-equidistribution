...
namespace OpConjecture.IndecomposableSkeleton.ARMeshRotationData
...
theorem two_successor_target_eq_inverse
  ...
  have hs_eq : s = O.tau.symm ⟨a, ha₀⟩ := by
    simp [s, OpConjecture.BoundaryTranslationChains.Data.successor, ha₀]
  ...
  calc
    ...
    _ = (O.tau.symm ⟨s, hsNI⟩).1.1.2 := by
      simp [OpConjecture.BoundaryTranslationChains.Data.successor, hsNI]
...
end OpConjecture.IndecomposableSkeleton.ARMeshRotationData
