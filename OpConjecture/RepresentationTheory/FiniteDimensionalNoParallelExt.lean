...
namespace OpConjecture.FiniteDimensionalNoParallelExt
...
theorem noParallelExtSupport :
  ...
  letI : FiniteDimensional K
    ...
    OpConjecture.NoParallelExtOne.moduleFinite_ext_one_of_finiteDimensional
      (K := K) (R := R)
  exact ⟨inferInstance,
    OpConjecture.NoParallelExtOne.finrank_ext_one_le_one_of_finite_skeleton
      sigma⟩

end OpConjecture.FiniteDimensionalNoParallelExt
