...
namespace OpConjecture.TwoVertexGabrielConnectedness

universe u w

open OpConjecture.TwoVertexArrowSupport
...
theorem underlyingConnected_of_blockConnected
  ...
  rcases
      OpConjecture.TwoVertexPeirceConnectedness.exists_cross_cotangent_of_blockConnected
...
variable {K S Peirce : Type u}
  ...
  {ι : Type v} [Finite ι]
  (σ : OpConjecture.IndecomposableSkeleton.{u, v, u} S ι)
...
theorem hasCrossExt_of_blockConnected
  ...
  apply
    OpConjecture.TwoVertexPeirceConnectedness.exists_cross_jacobson_cotangent_of_blockConnected
...
end OpConjecture.TwoVertexGabrielConnectedness
