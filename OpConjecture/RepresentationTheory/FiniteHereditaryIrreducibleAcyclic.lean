...
import OpConjecture.RepresentationTheory.IrreducibleReachability
...
theorem irreduciblePredecessorsOfProjectivesAreProjective_of_finitelyGeneratedLeftHereditary
  ...
  obtain ⟨f, hf⟩ := hxp
  rcases
      _root_.OpConjecture.RepresentationDirected.mono_or_epi_of_isIrreducibleMorphism
        hf with hmono | hepi
  · letI : Mono f := hmono
    exact
      _root_.OpConjecture.HereditaryThreeSimpleUnconditional.fgProjective_of_mono_to_fgProjective_of_finitelyGeneratedLeftHereditary
