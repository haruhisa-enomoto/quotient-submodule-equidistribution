...
theorem factorFunctor_kernel_isNilpotent_on_surviving_biproduct
  ...
  have hleft : left' ∈ Q.ideal.hom _ M' := by
    apply OpConjecture.Iyama.mem_radicalIdeal_of_biproduct_source_components
      Q left'
    intro i
...
theorem factorCategory_isIdempotentComplete (K : Set ι) :
  ...
  apply
    OpConjecture.CategoryTheory.IdempotentLifting.isIdempotentComplete_of_objectwise_nilpotent_kernel
      F
  intro X
