...
namespace OpConjecture.HereditaryTwoSimpleBoundary
...
theorem noParallelExtSupport_of_finiteDimensional :
  ...
  OpConjecture.FiniteDimensionalNoParallelExt.noParallelExtSupport sigma
...
theorem isNakayamaSkeleton_of_twoSimples_of_finitelyGeneratedLeftHereditary
  ...
  have hInjective :
      OpConjecture.SerialRingBridge.IsInjectiveNakayamaSkeleton sigma :=
...
theorem exists_capacity_predecessor
  ...
  have hJIndec : OpConjecture.Foundation.IsIndecomposableModule R (FGModuleCat.of R J) :=
...
end OpConjecture.HereditaryTwoSimpleBoundary
