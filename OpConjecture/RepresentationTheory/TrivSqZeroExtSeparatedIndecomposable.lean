...
namespace OpConjecture.TrivSqZeroExtSeparatedIndecomposable

open OpConjecture
open OpConjecture.TrivSqZeroExtSeparatedData
open OpConjecture.TrivSqZeroExtSeparatedCorrespondence
open OpConjecture.TrivSqZeroExtSeparatedModuleFunctor
...
theorem isIndecomposableSeparatedData_of_reconstructed
    ...
    (hD : OpConjecture.Foundation.IsIndecomposableModule
...
theorem module_isIndecomposable_iff_separatedData
    ...
    OpConjecture.Foundation.IsIndecomposableModule (TrivSqZeroExt S J) X ↔
  ...
  constructor
  · intro hX
    have hrec : @OpConjecture.Foundation.IsIndecomposableModule
  ...
  · intro hD
    ...
    exact @OpConjecture.Foundation.IsIndecomposableModule.of_linearEquiv
      (TrivSqZeroExt S J) (Reconstructed D) _ _
...
theorem moduleSeparatedData_isKernelFree_of_indecomposable
    [IsSemisimpleRing S]
    (X : ModuleCat.{w} (TrivSqZeroExt S J))
    (hX : OpConjecture.Foundation.IsIndecomposableModule (TrivSqZeroExt S J) X)
...
end OpConjecture.TrivSqZeroExtSeparatedIndecomposable
