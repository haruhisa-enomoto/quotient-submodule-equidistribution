...
namespace OpConjecture.LollipopConcrete.ModuleLayer.B0Classification
...
theorem classification : Classification K := by
  ...
  have hblock :
      ∀ i, OpConjecture.Foundation.IsIndecomposableModule
...
theorem indecomposable_iso_exactly_one
    ...
    (hM : OpConjecture.Foundation.IsIndecomposableModule (B0Model K) M) :
...
end OpConjecture.LollipopConcrete.ModuleLayer.B0Classification
