...
theorem rightModule_twoConvexGeometries
  ...
  exact
    ⟨OpConjecture.IndecomposableSkeleton.qClosure_isConvexGeometry_of_finiteDimensional
        (K := K) σ,
      OpConjecture.IndecomposableSkeleton.sClosure_isConvexGeometry_of_finiteDimensional
        (K := K) σ⟩
...
theorem rightModule_infiniteConvexStructures
  ...
  letI : ∀ i, FiniteDimensional K (σ.obj i) :=
    fun i ↦ finiteDimensional_rightFGModule K A (σ.obj i)
  exact
    OpConjecture.IndecomposableSkeleton.quotientSubmodule_infiniteConvexStructures_of_finiteDimensional
      (K := K) σ
...
theorem rightModule_qDistributiveCriterion
  ...
  letI : ∀ i, FiniteDimensional K (σ.obj i) :=
    fun i ↦ finiteDimensional_rightFGModule K A (σ.obj i)
  exact
    OpConjecture.IndecomposableSkeleton.qClosure_distributive_iff_union_iff_unaryGeneration
      (K := K) σ
...
theorem rightRepresentationFinite_finiteConvexConsequences
  ...
  letI : ∀ i, FiniteDimensional K (σ.obj i) :=
    fun i ↦ finiteDimensional_rightFGModule K A (σ.obj i)
  exact
    ⟨OpConjecture.IndecomposableSkeleton.qClosure_finiteConvexConsequences_of_finiteDimensional
        (K := K) σ,
      OpConjecture.IndecomposableSkeleton.sClosure_finiteConvexConsequences_of_finiteDimensional
        (K := K) σ⟩
...
theorem finiteRightModuleModel_twoConvexGeometries
  ...
  letI : ∀ i : M.ι, FiniteDimensional K (σ.obj i) :=
    fun i ↦ finiteDimensional_rightFGModule K A (σ.obj i)
  exact
    OpConjecture.IndecomposableSkeleton.twoConvexGeometries_of_finiteDimensional
      (K := K) σ
...
def FiniteRightModuleModel.Equidistribution
  ...
  letI : IsNoetherianRing Aᵐᵒᵖ :=
    isNoetherianRing_op_of_finiteDimensional K A
  M.skeleton.QuotientSubmoduleEquidistribution
...
def RightQuotientSubmoduleEquidistribution
  ...
  letI : Finite (CanonicalIndecomposableIndex.{uA, w} Aᵐᵒᵖ) :=
    hrep
  (rightIndecomposableSkeleton.{uK, uA, w} K A).QuotientSubmoduleEquidistribution
...
theorem rightQuotientSubmoduleEquidistribution_implies_weak
  ...
  letI : Finite (CanonicalIndecomposableIndex.{uA, w} Aᵐᵒᵖ) :=
    hrep
  exact
    OpConjecture.IndecomposableSkeleton.quotientSubmoduleEquidistribution_implies_weak
