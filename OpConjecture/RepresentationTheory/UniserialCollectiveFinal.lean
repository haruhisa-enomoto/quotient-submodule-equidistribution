...
namespace OpConjecture.UniserialCollectiveFinal
...
theorem moduleTop_isSimple_of_inFac_quotientChain_of_upperRadicalExtOneBound
  ...
  have hadd :
    ...
    OpConjecture.LengthThreePaperSpecialization.moduleRadical_inAdd_lengthTwoPair
      K A σ u.2 W Q T P
...
end OpConjecture.UniserialCollectiveFinal
