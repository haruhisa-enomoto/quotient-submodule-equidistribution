...
theorem uniqueCrossExtArrow_singleCrossTriangularAlgEquiv
  ...
  obtain ⟨hij, _hCornerOne, _hCornerZero, _hTotal,
    ...
    OpConjecture.QuotientSurvival.TwoCoordinateData.uniqueCrossExtArrow_singleCrossRadicalData
  ...
  exact ⟨OpConjecture.QuotientSurvival.TwoCoordinateData.singleCrossTriangularAlgEquiv
...
theorem uniqueExtArrow_singleCrossTriangularAlgEquiv_of_selfExt_subsingleton
    ...
    Nonempty (OpConjecture.A2Triangular.Model K ≃ₐ[K] B) :=
...
theorem extArrowCardOne_singleCrossTriangularAlgEquiv_of_selfExt_subsingleton
  ...
  exact
    OpConjecture.QuotientSurvival.TwoCoordinateData.uniqueExtArrow_singleCrossTriangularAlgEquiv_of_selfExt_subsingleton
