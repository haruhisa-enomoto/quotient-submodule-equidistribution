...
namespace OpConjecture.LollipopConcrete.ModuleLayer.NamedModules
...
theorem S1_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B0Model K) (S1Module K) := by
...
theorem S2_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B0Model K) (S2Module K) := by
...
theorem A_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B0Model K) (AModule K) := by
...
theorem X_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B0Model K) (XModule K) := by
...
theorem P_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B0Model K) (PModule K) := by
...
end OpConjecture.LollipopConcrete.ModuleLayer.NamedModules
