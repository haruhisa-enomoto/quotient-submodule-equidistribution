...
namespace OpConjecture.CPSLeftStandardLayers.Abstract
...
structure Input
    (d : OpConjecture.SetClosure.SaturatedSupportDeletionChain κ) where
...
variable {d : OpConjecture.SetClosure.SaturatedSupportDeletionChain κ}
  (I : Input (A := A) d)
...
end OpConjecture.CPSLeftStandardLayers.Abstract
