...
namespace OpConjecture.IndecomposableSkeleton.ProjectiveSimpleRank
...
def projectiveTopChoice (p : ProjectiveIndex sigma) :
  ...
  have hindec :
      OpConjecture.Foundation.IsIndecomposableModule R (projectiveTop sigma p) :=
...
end OpConjecture.IndecomposableSkeleton.ProjectiveSimpleRank
