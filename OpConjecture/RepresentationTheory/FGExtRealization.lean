...
namespace OpConjecture.FGExtRealization

universe u uQ vQ uOmega

open OpConjecture.NoParallelExtOne
...
instance inclusion_preservesProjectiveObjects :
  ...
  projective_obj {X} hX := by
    letI : Module.Projective R X :=
      OpConjecture.RingelStable.moduleProjective_of_fgProjective X hX
...
theorem _root_.OpConjecture.StableHomExtSoclePairing.exists_rightAlmostSplit
...
end OpConjecture.FGExtRealization
