...
namespace OpConjecture.CPSLeftStandardLayers
...
open OpConjecture.IndecomposableSkeleton.LegalSubobjectDeletionChain
...
theorem leftCoordinateProjective_indecomposable (i : κ) :
    OpConjecture.Foundation.IsIndecomposableModule Γ
...
def leftCoordinateProjectiveCover
  ...
  open OpConjecture.ProjectiveSimpleTop in
...
theorem leftCoordinateSimple_eq_of_iso
    ...
    i = j := by
  open OpConjecture.Tsukamoto.StandardSemantics in
  let pIso :
...
def simpleIsoLeftCoordinateSimpleOfNonzero
  ...
  letI : IsLocalRing
    ...
    OpConjecture.Foundation.isLocalRing_end_of_isIndecomposable (hfinite i) hindec
...
end OpConjecture.CPSLeftStandardLayers
