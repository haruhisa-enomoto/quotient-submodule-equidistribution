...
namespace OpConjecture.AuslanderTranspose
...
instance dTransposeι_mono (P : TwoStepProjectivePresentation X)
    (D : OpConjecture.ArtinDuality.Data R) : Mono (P.dTransposeι D) := by
...
theorem injective_nakayamaP₁ (P : TwoStepProjectivePresentation X)
    (D : OpConjecture.ArtinDuality.Data R) : Injective (P.nakayamaP₁ D) := by
...
end OpConjecture.AuslanderTranspose
