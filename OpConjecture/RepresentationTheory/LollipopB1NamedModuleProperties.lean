...
namespace OpConjecture.LollipopConcrete.B1.ModuleLayer.NamedModuleProperties
...
theorem S1_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (S1Module K) := by
...
theorem S2_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (S2Module K) := by
...
theorem A_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (AModule K) := by
...
theorem X_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (XModule K) := by
...
theorem U_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (UModule K) := by
...
theorem W_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (WModule K) := by
...
theorem P_indec :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (PModule K) := by
...
theorem namedModule_indec (i : NamedLabel) :
    OpConjecture.Foundation.IsIndecomposableModule (B1Model K) (namedModule K i) := by
  cases i
  · exact S1_indec K
  · exact S2_indec K
  · exact X_indec K
...
end OpConjecture.LollipopConcrete.B1.ModuleLayer.NamedModuleProperties
