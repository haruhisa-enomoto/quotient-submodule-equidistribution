...
namespace OpConjecture.TrivSqZeroExtSeparatedTrace

open OpConjecture.TrivSqZeroExtSeparatedData
open OpConjecture.TrivSqZeroExtSeparatedCorrespondence
open OpConjecture.TrivSqZeroExtSeparatedIndecomposable
...
theorem moduleTopTrace_eq_bot_of_semisimple_source_of_indecomposable_target
    ...
    (hY : OpConjecture.Foundation.IsIndecomposableModule
      (TrivSqZeroExt S J) Y)
...
end OpConjecture.TrivSqZeroExtSeparatedTrace
